...
def score_monthly_revenue(stock_id: str, revenue: pd.DataFrame) -> dict[str, object]:
    ...
    return {
        ...
        "revenue_data_month": latest.get("revenue_data_month"),
        "requested_revenue_month": latest.get("requested_revenue_month"),
        "latest_available_month": latest.get("latest_available_month"),
        "revenue_source_status": latest.get("revenue_source_status"),
