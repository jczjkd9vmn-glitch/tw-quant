...
def score_sector_strength(stock_id: str, sector: pd.DataFrame) -> dict[str, object]:
    ...
    return {
        ...
        "sub_industry": str(latest.get("sub_industry", "") or ""),
        "industry_source": str(latest.get("industry_source", "") or ""),
        "sector_strength_mode": str(latest.get("sector_strength_mode", "") or ""),
